...
directory = "/scratch/Infor/__pycache__/PostProcessing/Simulations/beta0.05/"
...
directory = "/scratch/Infor/__pycache__/PostProcessing/Simulations/beta0.2/"
directory2 = "/scratch/Infor/__pycache__/"
file_names = np.array(pd.read_csv(directory+'1metadata.csv', header=None))
heat_map_axes = [16]
heat_map_axes0 = [1]
...
directory = "/scratch/Infor/__pycache__/PostProcessing/Simulations/Co20.0/"
directory2 = "/scratch/Infor/__pycache__/"
file_names = np.array(pd.read_csv(directory+'1metadata.csv', header=None))
heat_map_axes = [16]
heat_map_axes0 = [1]
...
directory = "/scratch/Infor/__pycache__/PostProcessing/Simulations/Co5.0/"
directory2 = "/scratch/Infor/__pycache__/"
file_names = np.array(pd.read_csv(directory+'1metadata.csv', header=None))
heat_map_axes = [16]
heat_map_axes0 = [1]
